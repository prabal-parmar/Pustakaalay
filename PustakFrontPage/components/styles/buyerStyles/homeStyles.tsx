...
export const styles = StyleSheet.create({
  ...
  requestCard: {
    ...
    marginBottom: scale(12),
    borderWidth: 1,
    borderColor: "#E5E0D5", // Subtler border to match your search bar
    elevation: 3,
    shadowColor: "#000",
  ...
  priceContainer: {
    ...
    justifyContent: "space-between",
    alignItems: "center",
    backgroundColor: "rgba(28, 92, 22, 0.05)", // Very faint green tint
    padding: scale(12),
    borderRadius: scale(16),
    borderWidth: 1,
    borderColor: "rgba(28, 92, 22, 0.1)",
  },
  priceRow: {
    flexDirection: "row",
    alignItems: "center",
